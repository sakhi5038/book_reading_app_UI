                ...
                Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/images/book_theme_7.jpg'),
                        fit: BoxFit.fitWidth,
                      ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ChapterCard(
                        name: "Calmness",
                        chapterNumber: 1,
                        tag: "The heart is pure",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Enlighten",
                        chapterNumber: 2,
                        tag: "Somewhere in the Dark",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Discovery",
                        chapterNumber: 3,
                        tag: "The Dark is on the move",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Rev",
                        chapterNumber: 4,
                        tag: "The Moral of the story",
                        press: () {},
                      ),
                      SizedBox(height: 10),
                    ],
